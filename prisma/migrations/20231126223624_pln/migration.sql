...
-- AddForeignKey
ALTER TABLE `Report` ADD CONSTRAINT `Report_monthlyRecapId_fkey` FOREIGN KEY (`monthlyRecapId`) REFERENCES `MonthlyRecap`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `MonthlyRecap` ADD CONSTRAINT `MonthlyRecap_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
